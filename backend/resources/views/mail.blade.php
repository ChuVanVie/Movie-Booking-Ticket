                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding:25px 0;text-align:center">
                            <a href="http://localhost:8080"
                               ...
                               target="_blank"
                               data-saferedirecturl="https://www.google.com/url?q=http://localhost:8080&amp;source=gmail&amp;ust=1693987318192000&amp;usg=AOvVaw3-s6_uMcdO2zOUy3ugopDq">
                                <img
                                    src="https://ci3.googleusercontent.com/proxy/5uxvSydYjLK-NyZ8hSlo7ioBp7rrdMedM_W2Mfb0itpFJrJB3ON1cyZqjMwziFeDCQXj5ykF4VeMPTo-OActmw=s0-d-e1-ft#https://laravel.com/img/notification-logo.png"
                                    alt="Laravel Logo"
                    ...
                    <tr>
                        <td width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <table class="m_4569351854684113851inner-body" align="center" width="570" cellpadding="0"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                                            <a href="{{$resetLink}}"
                                                                               class="m_4569351854684113851button"
                                                                               rel="noopener"
                                                                               ...
                                                                               target="_blank"
                                                                               data-saferedirecturl="{{$resetLink}}">Reset
                                                                                Password</a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                    ...
                                                    <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';line-height:1.5em;margin-top:0;text-align:left;font-size:14px">
                                                        ...
                                                        into your web browser: <span
                                                            style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';word-break:break-all"><a
                                                                ...
                                                                target="_blank"
                                                                data-saferedirecturl="{{$resetLink}}">{{$resetLink}}</a></span>
                                                    </p>
                    ...
                    <tr>
                        <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                            <table class="m_4569351854684113851footer" align="center" width="570" cellpadding="0"
                                   cellspacing="0" role="presentation"
