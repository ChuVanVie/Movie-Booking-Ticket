...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Movie::create([
            ...
            'slug' => 'khong-mot-ai-biet-tnk',
            'country_id' => 5,
            'duration' => '138 phút',
            'year' => 2019,
            'decs' => '<p>Sevda là một cô gái rất xinh đẹp và năng động, mơ ước trở thành một ngôi sao. Ali có một quá khứ bí ẩn. Câu chuyện tình yêu phi thường của Ali và Sevda.</p>',
            'rating' => 8.5,
        ...
        Movie::create([
            ...
            'slug' => 'dang-sau-ke-phan-dien',
            'country_id' => 1,
            'duration' => '60 phút',
            'year' => 2023,
            'decs' => '<p>Một luật sư chăm chỉ chọn ngẫu nhiên các tù nhân đến thăm và tìm việc làm cho mình gặp một cựu cầu thủ bóng chày, đồng thời là chỉ huy thứ hai của một tổ chức tội phạm. Liệu anh ta có thể chống lại sự cám dỗ của cái ác?</p>',
            'rating' => 9.0,
        ...
        Movie::create([
            ...
            'slug' => 'mau-va-co-vat-phan-2',
            'country_id' => 4,
            'duration' => '40 phút',
            'year' => 2022,
            'decs' => "<p>Một chuyên gia về cổ vật hợp tác với một tên trộm nghệ thuật để truy bắt kẻ khủng bố tài trợ cho các cuộc tấn công của hắn bằng cách sử dụng các hiện vật bị đánh cắp.</p>",
            'rating' => 6.3,
        ...
        Movie::create([
            'movie_name' => 'Trấn Hồn Nhai 3',
            'slug' => 'tran-hon-nhai-3',
            'country_id' => 2,
            'duration' => '24 phút',
            'year' => 2023,
            'decs' => "<p>Trấn Hồn Nhai Phần 3 &nbsp; kể về câu chuyện Thiếu niên trấn hồng tướng Tào Diệm Binh sở hữu cơ thể Võ Thần, vì muốn tìm tung tích cha mẹ đã cùng thiếu nữ Hạ Linh và các đồng môn xâm nhập cấm địa Linh vực Lô Hoa Cổ Lâu, đồng thời triển khai giao chiến cùng tứ vương bảo vệ Phong Hoa Tuyết Nguyệt.</p>",
            'rating' => 8.0,
            'thumb_url' => 'https://img.ophim9.cc/uploads/movies/tran-hon-nhai-3-thumb.jpg',
            'poster_url' => 'https://img.ophim9.cc/uploads/movies/tran-hon-nhai-3-poster.jpg',
            'trailer_url' => 'https://hdbo.opstream5.com/share/392c071fb32b1da665da55ceda711c43'
        ]);

        Movie::create([
            'movie_name' => 'Tết ở làng địa ngục',
            'slug' => 'tet-o-lang-dia-nguc',
            'country_id' => 6,
            'duration' => '45 phút',
            'year' => 2023,
            'decs' => "Các hậu duệ của một băng cướp khét tiếng điều tra hàng loạt án mạng tàn bạo ở làng của họ. Liệu đây là nghiệp chướng hay &quot;tác phẩm&quot; của kẻ báo thù?",
            'rating' => 9.0,
        ...
        Movie::create([
            ...
            'slug' => 'tho-san-ac-linh',
            'country_id' => 7,
            'duration' => '23 phút',
            'year' => 2023,
            'decs' => "Một sinh viên khép kín có năng lực tâm linh bắt tay với cô bé kỳ lạ đang tìm kiếm linh hồn bị bắt cóc của người mẹ quá cố.",
            'rating' => 6.6,
        ...
        Movie::create([
            ...
            'duration' => '35 phút',
            'year' => 2023,
            'decs' => "<p>Chỉ với một miếng cắn, chiếc bánh quy bí ẩn tự làm biến giấc mơ thành hiện thực, nhưng nó lại chiếm lĩnh ngôi trường trung học ưu tú và những hậu quả chết người đang chờ đợi.</p>",
            'rating' => 8.8,
